...
class SimlTrainingFileLogger:
    ...
    def write(self, log_record: LogRecordItems) -> None:
        values = [
            ...
            log_record.train_loss.format(".5e"),
            log_record.train_other_losses.format(".5e"),
            log_record.validation_loss.format(".5e"),
            log_record.validation_other_losses.format(".5e"),
            log_record.elapsed_time.format(".2f")
        ]
